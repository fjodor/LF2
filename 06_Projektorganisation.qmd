...
::: {.incremental style="font-size: 1.8rem"}
- Der **Kritische Pfad** (=kritischer Weg) ist der Weg von Anfang bis Ende aller Aktivitäten eines Netzplans, auf die Summe aller Pufferzeit (minimal oder) Null wird.
...
- **Merke: Bei kritischen Pfad ist der Gesamtpuffer gleich Null.**
:::
